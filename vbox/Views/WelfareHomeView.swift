...
struct WelfareHomeView: View {
    ...
    private func destinationView(for platform: YBoxPlatform2) -> some View {
        if platform.name == "MissAV" {
            ...
            return AnyView(MadouMainView(platform: platform))
        } else {
    ...
    private func filteredPlatforms(for tab: WelfareTab) -> [YBoxPlatform2] {
        ...
        return all.filter { $0.name == "MissAV" || $0.name == "香蕉秀" || $0.name == "每日大乱斗" || $0.name == "每日大赛" || $0.name == "神秘电影" || $0.name == "四虎视频" || $0.name == "香肠派对" || $0.name == "色播聚合" || $0.name == "One平台" || $0.name == "麻豆平台" || $0.name == "麻豆免费" }
    }
    ...
    private func platformGradient(_ name: String) -> [Color] {
        let colorMap: [String: [Color]] = [
            ...
            "麻豆免费":      [Color(hex: "3B82F6"), Color(hex: "1D4ED8")],
        ]
